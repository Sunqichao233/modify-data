...
(async () => {
  ...
  // === 🧩 在这里填写要批量下载的用户名与课程名 ===
const tasks = [
    { user: "daiichi001", course: "AIプログラミング基礎コース" },
    { user: "daiichi002", course: "AIプログラミング基礎コース" },
    { user: "daiichi003", course: "AIプログラミング基礎コース" },
    { user: "daiichi008", course: "AIプログラミング基礎コース" },
    { user: "daiichi009", course: "AIプログラミング基礎コース" },
    { user: "daiichi010", course: "AIプログラミング基礎コース" },
    { user: "daiichi012", course: "AIプログラミング基礎コースコース" }
];
