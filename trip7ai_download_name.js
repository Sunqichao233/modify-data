...
(async () => {
  ...
  // === 🧩 在这里填写要批量下载的用户名与课程名 ===
const tasks = [
  { user: "趙　啓新", course: "AIサーバー構築実戦コース" },
  { user: "林　暁峰", course: "AIサーバー構築実戦コース" },
  { user: "胡　迪棚", course: "AIサーバー構築実戦コース" },
  { user: "田　秋実", course: "AIサーバー構築実戦コース" },
  { user: "曲　博", course: "AIサーバー構築実戦コース" },
  { user: "王　盛林", course: "AIサーバー構築実戦コース" },
  { user: "王　挹", course: "AIサーバー構築実戦コース" },
  { user: "徐　金代", course: "AIサーバー構築実戦コース" },
  { user: "梁　玉瑜", course: "AIサーバー構築実戦コース" },
  { user: "LIN　MENGXIN", course: "AIサーバー構築実戦コース" },
  { user: "易　玲", course: "AIサーバー構築実戦コース" },
  { user: "張　景濠", course: "AIサーバー構築実戦コース" },
  { user: "蔡　松安", course: "AIサーバー構築実戦コース" },
  { user: "馮　楊", course: "AIサーバー構築実戦コース" },
  { user: "譚　桂頴", course: "AIサーバー構築実戦コース" },
  { user: "柯　吉鵬", course: "AIサーバー構築実戦コース" },
  { user: "劉　鈺博", course: "AIサーバー構築実戦コース" },
  { user: "張浩然", course: "AIサーバー構築実戦コース" },
  { user: "李　揚揚", course: "AIサーバー構築実戦コース" },
  { user: "楊晨曦", course: "AIサーバー構築実戦コース" }
];
  ...
  async function downloadOne(targetValue, currentFileName) {
    ...
    // Step 3. 设置列与运算符
    selectCol.value = "nickname#categoryName";
